                ...
                >
                    ...
                    <div className="footer-brand">
                        ...
                        <p className="footer-tagline">
                            Building digital products as a team. From first sketch to shipped product.
                        </p>
                    ...
                    <div className="footer-col">
                        ...
                        <ul className="footer-links">
                            {navLinks.map((id) => (
                                <li key={id}>
                                    <button className="footer-link" onClick={() => handleNavClick(id)}>
                    ...
                    <div className="footer-col">
                        ...
                        <ul className="footer-links">
                            {services.map((s) => (
                                <li key={s}>
                                    <button className="footer-link" onClick={() => handleNavClick('services')}>
                                        {s}
                                    </button>
                                </li>
                            ))}
                    ...
                    <div className="footer-col">
                        ...
                        <div className="footer-contact">
                            ...
                            <div className="footer-contact-item">
                                <span className="footer-contact-icon">⌛︎</span>
